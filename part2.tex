...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.4\textwidth,]{backlog_sprint:1.png}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=1\textwidth,]{backlog_sprint:2.png}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.6\textwidth,]{backlog_sprint:3.png}
